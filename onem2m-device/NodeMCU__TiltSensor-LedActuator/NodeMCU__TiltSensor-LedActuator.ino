...
#define OFF_STATE  HIGH // *** External LED is active at HIGH, while Onboarded LED is active at LOW. 
#define ON_STATE LOW  // *** Adapat it is according to your config
...
#ifdef DEBUG
  Serial.println("tilt value = " + sensorValue);
#endif
